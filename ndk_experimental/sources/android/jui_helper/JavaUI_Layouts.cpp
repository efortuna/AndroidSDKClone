...
//JUILinearLayout
//-------------------------------------------------
std::map<std::string, int32_t> JUILinearLayout::map_attributes_;
ATTRIBUTE_TYPE JUILinearLayout::attributes_[] =
{
...
JUILinearLayout::JUILinearLayout( const bool b ) :
        JUIView()
{
    if( b == true )
        JUILinearLayout();
...
//Recreate Java Widget when the activity has been disposed
    ...
    while( itBegin != itEnd )
    {
        //Restore
        (*itBegin)->Restore();
        ndk_helper::JNIHelper::GetInstance()->CallVoidMethod( JUIWindow::GetHelperClassInstance(), "addView",
                "(Landroid/view/ViewGroup;Landroid/view/View;)V", GetJobject(), (*itBegin)->GetJobject() );
...
{
    ndk_helper::JNIHelper::GetInstance()->CallVoidMethod( JUIWindow::GetHelperClassInstance(), "addView",
            "(Landroid/view/ViewGroup;Landroid/view/View;)V", GetJobject(), view->GetJobject() );
...
//JUIRadioGroup
//-------------------------------------------------
JUIRadioGroup::JUIRadioGroup() :
        JUILinearLayout( false )
{
...
//JUIRelativeLayout
//-------------------------------------------------
std::map<std::string, int32_t> JUIRelativeLayout::map_attributes_;
ATTRIBUTE_TYPE JUIRelativeLayout::attributes_[] =
{
{ "Gravity", ATTRIBUTE_PARAMETER_INT },
{ "HorizontalGravity", ATTRIBUTE_PARAMETER_INT },
...
JUIRelativeLayout::JUIRelativeLayout( const bool b ) :
        JUIView()
{
    if( b == true )
        JUIRelativeLayout();
