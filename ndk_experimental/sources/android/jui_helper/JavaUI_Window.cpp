        ...
        void* id )
{
    ...
    if( mid == NULL )
    {
        ...
        if( mid == NULL )
        {
            LOGI( "method ID 'createWidget', '(Ljava/lang/String;I)Landroid/view/View;' not found" );
            helper->Unlock();
            return NULL;
        }
    }
        ...
        const int32_t param )
{
    ...
    if( mid == NULL )
    {
        mid = env->GetMethodID( jni_helper_java_class_, "createWidget", "(Ljava/lang/String;II)Landroid/view/View;" );
        if( mid == NULL )
        {
            LOGI( "method ID 'createWidget', '(Ljava/lang/String;II)Landroid/view/View;' not found" );
            helper->Unlock();
            return NULL;
        }
    }

    jobject obj = env->CallObjectMethod( jni_helper_java_ref_, mid, name, (int32_t) id, (int32_t) param );
    obj = env->NewGlobalRef( obj );
